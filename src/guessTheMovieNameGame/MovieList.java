...
public class MovieList {
	...
	/**
	 * Class constructor that stores the movie titles contained a file in an
	 * {@link ArrayList}, until it scans all lines in the file, if a valid path to
	 * the file exists or warns the user otherwise.
	 *
	...
	/**
	 * Method that generates a random {@link Integer} from 0 to the number of movie
	 * titles in the list minus 1, and returns the movie title in the movies
	 * {@link ArrayList} with that index.
	 *
